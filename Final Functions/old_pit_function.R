...
# must name object you create with this funciton 'old_dat' in order for it to propagate into main PIT data function
######################
...
old_pit<- function(path_to_folder){
...
assign("old_dat", o_d1, envir=globalenv())
assign("old_event", o_e1, envir=globalenv())
assign("old_other", o_o, envir=globalenv())
#return(o_d1)
}

#User identifies location of data files only
old_pit("~/Dropbox (Instream)/Projects/19 - Keogh River Fish Fence/5 - Data/2016/PIT/Old Format PIT Files")
